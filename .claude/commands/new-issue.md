...
3b. Sweep for optional sections per CLAUDE.md: check this week's AI-geopolitics coverage in the whitelisted outlets (Foreign Affairs, The Economist, FT, Lawfare, War on the Rocks, Carnegie, CSIS, Brookings, RAND) for "The long game", and scan Polymarket/Kalshi/Metaculus for AI-security-relevant markets for "The odds" (follow the liquidity and framing rules in CLAUDE.md). Include an optional section only if the material clears the same quality bar as the main stories — when in doubt, leave it out and tell the editor what you considered and rejected.
